...
public class ExtentReportManager implements ITestListener
{
	...
	{		
		...
		repName="guru99BankExecution-Report-"+timeStamp+".html";
				
		htmlReporter=new ExtentHtmlReporter("C:\\Users\\rarav\\eclipse-workspace\\guru99BankMiniProject\\reports\\"+repName);//specify location of the report
				
		htmlReporter.config().setDocumentTitle("guru99 Bank Automation Report"); // Tile of report
		htmlReporter.config().setReportName("guru99 Bank Regression Testing"); // name of the report
